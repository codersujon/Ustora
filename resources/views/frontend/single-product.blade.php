                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="product-images">
                                    <div class="product-main-img">
                                        <img src="{{ asset('backend/img/'.$singleP->image) }}" alt="">
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    <h2 class="product-name">{{ $singleP->name }}</h2>
                                    ...
                                    <div class="product-inner-category">
                                        <p>Category: <a href="">{{ $singleP->category_name }}</a>. Tags: <a href="">awesome</a>, <a href="">best</a>, <a href="">sale</a>, <a href="">shoes</a>. </p>
                                    </div>
